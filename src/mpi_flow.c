...
{    
    ...
    while ( i_next_stack < N_iter )
    {
        ...
        //
        mpi_static_sigma_stack(status, my_rank, n_ranks, root_rank, rootsent_tag, slavereturn_tag, transit_BetaParm_root, n_iter_a_stack, n_iter_a_batch_base, n_iter_a_batch_rand, i_save_begin, nline_data, data_NlineNdim, ptr_sigma_prop, ptr_i_accumul, ptr_i_accumul_accept, logpost_allranks_root, running_Beta_Values, transit_BetaParmdx_root);
        // 
